        ...
        <main class="mobile-content">
            ...
            <form action="${pageContext.request.contextPath}/agent/status/edit" method="post">
                <div class="status-options-list">
                    ...
                    <!-- 근무중 -->
                    <label class="status-option-card type-active">
                        <input type="radio" name="workStatus" value="근무중" class="status-option-input" ${user.workStatus eq '근무중' or empty user.workStatus ? 'checked' : ''}>
                    ...
                    <label class="status-option-card">
                        <input type="radio" name="workStatus" value="휴식중" class="status-option-input" ${user.workStatus eq '휴식중' ? 'checked' : ''}>
                        <span class="custom-radio"></span>
                        <div class="status-text-group">
                    ...
                    <!-- 외출중 -->
                    <label class="status-option-card">
                        <input type="radio" name="workStatus" value="외출중" class="status-option-input" ${user.workStatus eq '외출중' ? 'checked' : ''}>
                        <span class="custom-radio"></span>
                        <div class="status-text-group">
                ...
                <div class="action-buttons">
                    <a href="${pageContext.request.contextPath}/agent/main" class="btn btn-cancel">취소</a>
...
<script type="text/javascript">var currentStatus = "${empty user.workStatus ? '근무중' : user.workStatus}";</script>
<script src="${pageContext.request.contextPath}/resources/js/agent/agentStatusEdit.js"></script>

	...
	<div class="mobile-container">
		...
		<main class="mobile-content">
			<div class="alert-banner">
				<i class="fa-solid fa-circle-exclamation alert-icon"></i> <span>긴급
					상황 발생 시 신속하게 보고해주세요.</span>
			</div>
			...
			<form id="emergencyForm" class="report-form">
				...
				<input type="hidden" name="situType" value="긴급보고"> <input
					type="hidden" name="situStatus" value="감지">


				<!-- 위험 유형 -->
				<div class="form-group">
					<label class="form-label" for="dngrType">보고 유형 (위험 유형)<span
						class="required-star">*</span></label> <select id="dngrType"
						name="dngrType" class="form-select">
				...
				<!-- 위험 단계 -->
				<div class="form-group">
					<label class="form-label" for="dngrLevel">위험 단계<span
						class="required-star">*</span></label> <select id="dngrLevel"
						name="dngrLevel" class="form-select">
				...
				<!-- 구역명 -->
				<div class="form-group">
					<label class="form-label" for="zoneName">발생 구역<span
						class="required-star">*</span></label> <select id="zoneName"
						name="zoneName" class="form-select">
				...
				<div class="form-group">
					...
					<div class="location-toggle-row">
						<div class="location-text">
							<i class="fa-solid fa-user-shield icon-disabled-lead"></i> <span
								class="text-disabled-title">${user.userName}</span>
						</div>
				...
				<!-- 감지내용 -->
				<div class="form-group">
					<label class="form-label" for="situContent">상황 내용 (감지 내용)<span
						class="required-star">*</span></label>
					<div class="textarea-wrapper">
						<textarea id="situContent" name="situContent"
							class="form-textarea" maxlength="300"
							placeholder="상황에 대해 상세히 입력해주세요."></textarea>
				...
				<div class="form-btn-group">
					...
					<button type="submit" id="btnSubmitEmergency"
						class="btn-submit btn-emergency-submit">긴급 등록</button>
				</div>
			</form>
		</main>
	</div>

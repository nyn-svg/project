...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/agent/agentMain.css">
</head>
<body>
		...
		<main class="mobile-content">
			...
			<section class="notice-section">
				...
				<div class="notice-list">
					<!-- 1. 위험 상황 전파 -->
					<button type="button" class="notice-item danger rule-item"
					...
					<!-- 2. 인파 밀집 대응 -->
					<button type="button" class="notice-item warning rule-item"
